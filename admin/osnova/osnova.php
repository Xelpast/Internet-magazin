...
$str=$url[4];
echo $str;
$sql2="UPDATE osnova SET price=:price, pricez=:pricez, namer=:namer, filenames=:filenames WHERE id=$str";
$query=$pdo->prepare($sql2);
$query->execute(["price" => $price, "pricez" => $pricez, "namer" => $namer, "filenames"=>$_FILES['im']['name']]);
